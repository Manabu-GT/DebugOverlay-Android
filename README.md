...
If you dismiss the metadata dialog instead of submitting, DebugOverlay saves the capture as a **draft** (stored in app data). Next time you open Bug Report, you can resume or delete saved drafts.
