...
import static com.ms.square.debugoverlay.modules.LogcatLineFilter.DEFAULT_LINE_FILTER;
...
public class LogcatViewModule extends BaseViewModule<LogcatLine> {
  ...
  public static interface DataModule<T> {
  ...
  public static interface DataObserver<T> {
  ...
  public abstract static class OverlayModule<T> implements DataModule<T>, ViewModule<T> {
  ...
  public static interface ViewModule<T> extends DataObserver<T> {
